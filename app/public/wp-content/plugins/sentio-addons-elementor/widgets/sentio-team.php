 ...
 * @since 1.1.0
 */
class Sentio_Team extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Sentio Team Member', 'sentio-addons' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_slides',
			[
				'label' => __( 'Sentio Team Member', 'sentio-addons' ),
			]
		);
		...
		$repeater->add_control(
			'bio',
			[
				'label' => __( 'Bio', 'sentio-addons' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Bio', 'sentio-addons' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			...
			'headshot',
			[
				'label' => _x( 'Headshot', 'sentio-addons' ),
		...
		$this->add_control(
			'slides',
			[
				'label' => __( 'Team Members', 'sentio-addons' ),
	...
	protected function render() {
       ...
       if ($settings['pause_on_hover'] == 'yes') {
		...
		foreach ( $settings['slides'] as $slide ) {
			...
			if ( $slide['headshot'] ) {
				$slide_html .= '<img class="elementor-slide-image" src="' . $slide['headshot']['url'] . '">';
			}
	...
	protected function _content_template() {
		...
		#>
		<div class="swiper">
			<div class="slides-wrapper elementor-main-swiper sentio-team" dir="{{ direction }}" data-animation="{{ settings.content_animation }}">
				<div class="">
